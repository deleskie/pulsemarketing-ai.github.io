...
const benefitCards = [
  {
    ...
    description:
      'Blend hospitality, retail, and experiential signals into one luminous dashboard so shifts, channels, and vendors stay synchronized.',
  },
  {
    title: 'Copilots that sound like your brand',
    description:
      'Storyteller briefs execs, stylists, concierges, and field teams with cinematic recaps that translate data into confident action.',
  },
  {
    title: 'Launches that learn on their own',
    description:
      'Pulse Playbooks rebalance spend, creative, and staffing every hour so campaigns feel bespoke without extra headcount.',
  },
];
    ...
    <>
      ...
      <section className="hero">
        <div className="hero__inner">
          ...
          >
            ...
            <h1>Stage cinematic brand moments with an AI-powered launch studio.</h1>
            <p>
              Give your marketing, ops, and guest teams a shared, data-rich pulse. Pulse Marketing AI spots signals before they fade, turns them into shoppable stories, and keeps every activation on tone, on budget, and on time.
            </p>
            ...
            <div className="hero__dashboard">
              <div className="hero__dashboard-header">
                <span className="badge badge--accent">
                  <img src="/logo.svg" alt="Pulse Marketing AI glyph" /> Live pulse
                </span>
      ...
      <section className="section trust">
        <div className="trust__inner">
          <span className="trust__eyebrow">Crafted with teams who run on vibes and rigor</span>
      ...
      <section className="section benefits">
        <div className="section__header">
          ...
          <h2 className="section__title">One luminous platform that never drops the beat.</h2>
        </div>
      ...
      <section className="section launch-modes" id="ideas">
        <div className="section__header">
          ...
          <h2 className="section__title">Three distinct ways to activate Pulse Marketing AI.</h2>
          <p className="section__subtitle">
            Choose a concept that matches the energy of your brand. Each mode blends technology, service, and storytelling into a turnkey experience.
          </p>
        </div>
      ...
      <section className="section section--dark" id="platform">
        <div className="section__header">
          ...
          <h2 className="section__title">The tech spine behind every Pulse moment.</h2>
          <p className="section__subtitle">
            Under the glow is a rigorously engineered marketing OS. It sees every signal, predicts what is next, and keeps teams compliant without diluting creativity.
          </p>
        </div>
      ...
      <section className="section insight">
        <div className="section__header">
          ...
          <h2 className="section__title">Watch sentiment, spend, and stories evolve in one feed.</h2>
          <p className="section__subtitle">
            The Resonance Monitor pairs quantitative lift with qualitative texture so every decision blends art and science.
          </p>
        </div>
        <div className="insight-showcase">
          <div className="insight-showcase__panel insight-showcase__panel--metrics">
            ...
            <p>Track campaign velocity, loyalty heatmaps, and experiential ROI with second-by-second clarity.</p>
          ...
          <div className="insight-showcase__panel insight-showcase__panel--story">
            ...
            <p>
              Deliver cinematic recaps and mitigation blueprints grounded in the same data your finance and ops teams trust.
            </p>
            <ul>
              <li>AI narratives contextualized with location, persona, and crew notes</li>
              <li>Escalation playbooks triggered the moment signals wobble</li>
              <li>Turnkey exports into executive briefings, investor updates, and press kits</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="section testimonials" id="proof">
        <div className="section__header">
          ...
          <h2 className="section__title">Operators who glow with Pulse Marketing AI.</h2>
        </div>
      ...
      <section className="section section--dark">
        <div className="section__header">
          ...
          <h2 className="section__title">Co-create your first Pulse chronicle.</h2>
          <p className="section__subtitle">
            Our immersion sprint maps your launch calendar, data sources, and guest experience to the Pulse framework. Walk away with a 90-day plan and a pilot ready to glow.
          </p>
        </div>
        <div className="cta-panel">
          <div>
            ...
            <p>
              Meet with a strategist to align goals, data, and activation rituals. We will choreograph your first three drops together and leave you with a reusable blueprint.
            </p>
          </div>
